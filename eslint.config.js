...
const extensionRuntimeGlobals = readonly([
    ...
    'DashBridgeGrafanaCpuCapacityLegend', 'DashBridgeGrafanaLegendVisibilityAdapters', 'DashBridgeGrafanaLegendVisuals',
    'DashBridgeGrafanaPanelDataTransforms', 'DashBridgeGrafanaPanelIdentity',
    'DashBridgeGrafanaReportSnapshot', 'DashBridgeGrafanaRuntimeManifest',
    ...
    'DashBridgeOperationProgress', 'DashBridgeOptionsConfigTransfer', 'DashBridgePanelDefinition', 'DashBridgeProfileStore',
    ...
    'DashBridgeRecorderActionCapture', 'DashBridgeRecorderDashflowController', 'DashBridgeRecorderNetworkCapture',
    'DashBridgeRecorderReplay', 'DashBridgeRecorderSessionController',
    ...
    'installRuntimeDiagnostics', 'localExportTimestamp', 'localIsoTimestamp', 'normalizeGrafanaSettings',
