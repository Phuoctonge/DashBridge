...
checks = {
    ...
    "Command runner is shared by Popup and Batch": all("js/shared/grafana-command.js" in (ROOT / page).read_text(encoding="utf-8") for page in ("html/popup.html", "html/batch.html")),
}
run_checks(checks)
