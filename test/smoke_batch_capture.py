...
if __name__ == "__main__":
    run_page_contract(
        ...
        sources={
            ...
            "pages/batch/batch-series-run-controller.js": [
                "discovery.discoverForSlice",
                "seriesSelection.resolvePatterns",
                "includePattern",
                "ignorePattern",
            ],
            "pages/batch/batch-page-controller.js": ["copyMainSettingsToSeriesBtn", "normalizeTimeRangesField", "getCaptureTheme"],
            "pages/batch/batch-series-discovery-controller.js": ["const loadSelectedPanels = async () =>", "discoverForSlice", "waitForCapturedSeries"],
